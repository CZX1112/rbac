...
INSERT INTO `permissions` VALUES (3, '用户管理', '可以管理用户的权限', '/user/manage');
...
INSERT INTO `user` VALUES (2, 'user1', '用户1', '123456', '15160716906', 'xm@example.com', '北京市海淀区', '男', 1, NOW(), NOW());
INSERT INTO `user` VALUES (3, 'superadmin', '超级管理员', '123456', '13679058631', 'boss@example.com', '福建省厦门市思明区', '男', 1, NOW(), NOW());
